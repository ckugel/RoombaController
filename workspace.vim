...
set winminwidth=0
set winwidth=1
exe '1resize ' . ((&lines * 24 + 19) / 38)
exe 'vert 1resize ' . ((&columns * 145 + 94) / 189)
exe '2resize ' . ((&lines * 24 + 19) / 38)
exe 'vert 2resize ' . ((&columns * 43 + 94) / 189)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 15 - ((6 * winheight(0) + 12) / 24)
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 71 + 94) / 189)
exe 'vert 2resize ' . ((&columns * 117 + 94) / 189)
argglobal
5argu
...
silent! normal! zE
let &fdl = &fdl
let s:l = 66 - ((6 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 66
...
silent! normal! zE
let &fdl = &fdl
let s:l = 174 - ((15 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 174
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 65 + 94) / 189)
exe 'vert 2resize ' . ((&columns * 123 + 94) / 189)
argglobal
1argu
...
silent! normal! zE
let &fdl = &fdl
let s:l = 92 - ((23 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 92
...
exe 'vert 2resize ' . ((&columns * 126 + 94) / 189)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 26 - ((9 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 26
...
wincmd =
argglobal
if bufexists(fnamemodify("src/util.hpp", ":p")) | buffer src/util.hpp | else | edit src/util.hpp | endif
if &buftype ==# 'terminal'
  silent file src/util.hpp
endif
balt src/util.cpp
setlocal fdm=manual
setlocal fde=0
...
silent! normal! zE
let &fdl = &fdl
let s:l = 34 - ((6 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 34
...
wincmd w
argglobal
if bufexists(fnamemodify("src/util.cpp", ":p")) | buffer src/util.cpp | else | edit src/util.cpp | endif
if &buftype ==# 'terminal'
  silent file src/util.cpp
endif
balt src/util.hpp
setlocal fdm=manual
setlocal fde=0
...
silent! normal! zE
let &fdl = &fdl
let s:l = 456 - ((9 * winheight(0) + 17) / 35)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 456
